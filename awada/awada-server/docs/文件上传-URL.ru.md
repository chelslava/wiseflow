    ...
    post:
              ...
              properties:
                ...
                params:
                  ...
                  properties:
                    ...
                    fileType:
                      type: integer
                      description: '1: jpg изображение, 4: mp4 видео, 5: файл (включая .amr аудио)'
                  required:
                    - guid
                    - filename
                    - fileUrl
      ...
      responses:
        '200':
          ...
          x-apifox-name: Успех
      security: []
      x-apifox-folder: Модуль CDN облачного хранения
